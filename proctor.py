...
Original file is located at
    https://colab.research.google.com/drive/1VjYj9OD044-uCChtA8gnulZ8ijtuEuIe
...
VIDEO_PATH = "/content/drive/My Drive/OnlineExaminationSystem/Video1.mp4" #change it depending on the path of the video recording
# For the suspicious images to be stored for further review
SUSPICIOUS_DIR = "/content/drive/My Drive/OnlineExaminationSystem/Suspicious"
# For loading shape_68.dat file
DLIB_PREDICTOR_PATH = "/content/drive/My Drive/OnlineExaminationSystem/shape_68.dat"
# For loading pre-trained FaceNet model
FACENET_PATH = "/content/drive/My Drive/OnlineExaminationSystem/facenet_keras.h5"
# For fetching the image from records to run face verification
IMAGE_PATH = "/content/drive/My Drive/OnlineExaminationSystem/student.jpg" #change it depending on the name of the student's image
